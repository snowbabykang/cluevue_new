...
<div class="container">
    <div class="clearfix centermodel">
        ...
        <div class="form-group  clearfix">
            ...
            <input type="password" id="inputPassword" class="form-control" v-model="newPassword">
        </div>
         <div class="form-group  clearfix">
            <!--a href="#" class="pull-right label-forgot">Forgot password?</a-->
            <label for="inputPassword">新密码:</label>
        ...
        <!-- <div class="or-box">
            ...
            <div class="row-block">
                ...
                <div class="col-md-12 row-block">
                    <a @click="userfind" class="btnup">确认</a>
                </div>
            </div>
        </div> 
        <h4>中共承德市纪律检查委员会</h4>
  ...
  <form role="form" class="clearfix" v-if="false">
                            <div class="form-group">
                                <!--a href="#" class="pull-right label-forgot">Forgot email?</a-->
                                <label for="inputUsernameEmail">用户名</label>
                                <input type="text" v-model="loginName" id="inputUsernameEmail" class="form-control">
                            </div>
                            <div class="form-group">
                                <!--a href="#" class="pull-right label-forgot">Forgot password?</a-->
                                <label for="inputPassword">密码</label>
                                <input type="password" v-model="newPassword" id="inputPassword" class="form-control">
                            </div>
                             <div class="form-group">
                                <!--a href="#" class="pull-right label-forgot">Forgot password?</a-->
            ...
            <div class="row-block">
                <div class="row">
                <div class="col-md-12 row-block">
                    <button @click="userfind" class="btn btn-primary btn-block">登录</button>
                </div>
            </div>
        </div> 
                        </form>
